    ...
    public class OrderResponseDTO {
        ...
        /**
         * address being linked with order
         */
        ...
        public OrderResponseDTO(Long id, Long userId, Long restaurantId, Double totalAmount, OrderStatus status, LocalDateTime createdAt, String address) {
            this.id = id;
            this.userId = userId;
